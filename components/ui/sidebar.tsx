    ...
    return (
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            className={cn(
              "group/sidebar-wrapper flex h-svh w-full has-[[data-variant=inset]]:bg-sidebar has-[[data-variant=inset]]:p-2",
              className
            )}
            ref={ref}
            style={
  ...
  return (
    <main
      className={cn(
        ...
        "overflow-hidden md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
        className
      )}
      ref={ref}
      {...props}
